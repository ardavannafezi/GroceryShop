...
namespace GroceryShop.RestApi.Controllers
{
    ...
    [Route("api/categoryProfit")]
    [ApiController]
    public class CategoryProfitController : ControllerBase
    {
        private readonly ProfitAppServices _sut;

        public CategoryProfitController(ProfitAppServices service)
        {
            _sut = service;
        }
        ...
        {
            return _sut.GetCategoryProfit(id);
        }
