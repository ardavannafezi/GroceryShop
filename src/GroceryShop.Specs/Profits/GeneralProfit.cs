...
namespace GroceryShop.Specs.Profit
{
    ...
    public class GeneralProfit : EFDataContextDatabaseFixture
    {
        ...
        public GeneralProfit(ConfigurationFixture configuration) : base(configuration)
        {
