...
namespace GroceryShop.Specs.Profit
{
    ...
    [Feature("",
       ...
       InOrderTo = "سود کالا را مشاهده کنم"
   )]
    public class ProductProfit : EFDataContextDatabaseFixture
    {
        ...
        public ProductProfit(ConfigurationFixture configuration) : base(configuration)
        {
        ...
        [Given("قیمت خرید کالا ها 5000 و فروش 10000")]
        public void Given()
        {
        ...
        public void When()
        {
            profit = _sut.GetProductProfit(1);
        }
